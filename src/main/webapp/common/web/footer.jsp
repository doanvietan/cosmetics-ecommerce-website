            ...
            <div class="row row-25">
                ...
                <div class="footer-widget col-lg-3 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
                    ...
                    <div class="payment-box mt-15 mb-15">
                        <a href="#"><img src="<c:url value='/template/web/images/payment.png'/>" alt=""></a>
                    </div>
                </div>
                <!--Footer Widget end-->
            </div>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-sm-4">
                    <div class="footer-logo text-right">
                        <a href="<c:url value='/index.html'/>"><img src="<c:url value='/template/web/images/logofoo.png'/>" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
