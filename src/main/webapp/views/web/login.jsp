		...
		<div class="container">
			<div class="row">
                ...
                "slidesToShow": 1
					...
					<div class="brand col">
						<a href="#"><img
							src="${pageContext.request.contextPath}/assets/images/brands/brand-1.png"
							alt=""></a>
					</div>
					<div class="brand col">
						<a href="#"><img
							src="${pageContext.request.contextPath}/assets/images/brands/brand-2.png"
							alt=""></a>
					</div>
					<div class="brand col">
						<a href="#"><img
							src="${pageContext.request.contextPath}/assets/images/brands/brand-3.png"
							alt=""></a>
					</div>
					<div class="brand col">
						<a href="#"><img
							src="${pageContext.request.contextPath}/assets/images/brands/brand-4.png"
							alt=""></a>
					</div>
					<div class="brand col">
						<a href="#"><img
							src="${pageContext.request.contextPath}/assets/images/brands/brand-5.png"
							alt=""></a>
					</div>
				</div>
				<!--Brand Slider end-->
